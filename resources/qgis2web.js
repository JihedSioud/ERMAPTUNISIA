...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32632',
            //extent: [349709.149179, 3343825.951490, 745134.595851, 4156981.168420],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([169809.431323, 3524567.223618, 925676.108916, 4136495.181948], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Informations Urgences Tunisie</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_structure_urgenceMap_3,
    colName: 'libelle_st',
    zoom: 10,
    collapsed: true,
    map: map
