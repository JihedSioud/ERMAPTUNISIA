...
function exp_structure_urgenceMap_3rule0_eval_expression(context) {
    // TYPE = 'HU'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TYPE')  == 'HU');
    } else {
        return (feature.get('TYPE')  == 'HU');
    }
}
...
function exp_structure_urgenceMap_3rule1_eval_expression(context) {
    // Type_struc = 'HR'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Type_struc')  == 'HR');
    } else {
        return (feature.get('Type_struc')  == 'HR');
    }
}
...
function exp_structure_urgenceMap_3rule2_eval_expression(context) {
    // Type_struc = 'HC'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Type_struc')  == 'HC');
    } else {
        return (feature.get('Type_struc')  == 'HC');
    }
}
...
function exp_structure_urgenceMap_3rule3_eval_expression(context) {
    // Type_struc = 'IS'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Type_struc')  == 'IS');
    } else {
        return (feature.get('Type_struc')  == 'IS');
    }
}
...
function exp_structure_urgenceMap_3rule4_eval_expression(context) {
    // Type_struc = 'CSB'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Type_struc')  == 'CSB');
    } else {
        return (feature.get('Type_struc')  == 'CSB');
    }
}
...
function exp_structure_urgenceMap_3rule5_eval_expression(context) {
    // Type_struc = 'SAMU'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Type_struc')  == 'SAMU');
    } else {
        return (feature.get('Type_struc')  == 'SAMU');
    }
}